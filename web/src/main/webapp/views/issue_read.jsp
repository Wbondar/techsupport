...
<body>
  <aside>
    <section>
      <h2>Add tag.</h2>
      <form method='POST' action='/issue/update/tag/assign'>
        ...
        <%
          ...
          if (tags != null && !tags.isEmpty( ))
          {
            ...
            for (Tag tag : tags)
            {
              ...
              stringBuilder.append("<form method='POST' action='/issue/update/tag/unassign'>");
            ...
            for (Comment comment : comments)
            {
              stringBuilder.append("<article>");
                ...
                stringBuilder.append("<section>");
                  stringBuilder.append("<h4>Responde.</h4>");
                  stringBuilder.append("<form method='POST' action='/comment/create'>");
                    stringBuilder.append("<input type='hidden' name='parent_id' value='" + comment.getId( ) + "' required />");
                    stringBuilder.append("<textarea name='message' required></textarea>");
                    stringBuilder.append("<input type='submit' />");
                  stringBuilder.append("</form>");
                stringBuilder.append("</section>");
              stringBuilder.append("</article>");
